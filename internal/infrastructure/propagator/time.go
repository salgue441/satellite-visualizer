...
// MinutesSinceEpoch returns the number of minutes between two Julian Dates.
func MinutesSinceEpoch(epochJD, targetJD float64) float64 {
	return (targetJD - epochJD) * MinutesPerDay
}
